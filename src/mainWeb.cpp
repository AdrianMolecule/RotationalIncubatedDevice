...
//     // char* mutablePtr = "World";
//     //const char* constantPtr = static_cast<const char*>(mutablePtr); we should be able to pass a char* to a method that takes a const char*
...
//         return;
//     }
//     webSocket.broadcastTXT(data);//sends sensor data from board to display that is picked and updated on the screen by the javaScript
