...
// bool JsonWrapper::saveModelToFile(const char* path, const std::vector<Field>& fields) {
...
// bool JsonWrapper::loadModelFromFile(const char* path, std::vector<Field>& fields) {
